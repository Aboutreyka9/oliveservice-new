        ...
        <div style="display: flex; align-items: center; gap: 14px;">
          ...
          <div>
            ...
            <p style="color: #64748B; font-size: 13px; margin: 4px 0 0 0; font-weight: 500;">
              Date : <strong><?= !empty($item['date_cloture']) ? date('d/m/Y', strtotime($item['date_cloture'])) : date('d/m/Y') ?></strong> &bull; Réf : <code style="font-weight: 800; color: #1E3A5F; background: #F1F5F9; padding: 2px 6px; border-radius: 4px; border: 1px solid #CBD5E1;"><?= htmlspecialchars($item['code_cloture'] ?? '-') ?></code>
            </p>
          </div>
        </div>
