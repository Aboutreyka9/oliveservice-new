    ...
    <div class="content-wrapper" style="padding: 24px; width: 100%; max-width: 100%; box-sizing: border-box;">
        ...
        <div style="display: flex; align-items: center; gap: 14px;">
          ...
          <div>
            ...
            <p style="color: #64748B; font-size: 13px; margin: 4px 0 0 0; font-weight: 500;">
              Gestion des articles et produits individuels servant à composer les packs de souscription
            </p>
          </div>
        </div>

        <?php if (Context::can('GESTIONNAIRE_MANAGE_ARTICLES')): ?>
      ...
      <div class="card-premium" style="background: #FFFFFF; border-radius: 16px; padding: 28px; border: 1px solid #E2E8F0; box-shadow: 0 10px 25px -5px rgba(15, 23, 42, 0.05), 0 8px 10px -6px rgba(15, 23, 42, 0.01); width: 100%; box-sizing: border-box; overflow: hidden;">
        <div style="width: 100%; overflow-x: auto; -webkit-overflow-scrolling: touch;">
          <table id="table-articles" class="table display nowrap" style="width:100%; max-width:100%; border-collapse: collapse; font-size: 13px;">
            <thead>
              <tr style="background: #F8FAFC; text-align: left; color: #64748B; border-bottom: 2px solid #E2E8F0;">
                ...
                <th style="padding: 14px 16px; font-weight: 800; text-transform: uppercase; font-size: 11px; letter-spacing: 0.5px;">Désignation / Nom de l'Article</th>
...
$(document).ready(function() {
  var table = $('#table-articles').DataTable({
    ...
    columns: [
      ...
      { data: 'code_article', width: '130px', render: function(d) {
        if (!d) return '-';
